...
// The metabox may not be present on all pages, so check for its existence before creating the element.
if ( domElement === null ) {
	console.warn( 'Could not find the UMich OIDC metabox element. Check plugin settings to include this post type.' );
} else {
